(function ($) {
  ...
  if (isMobile.any()) {
    $(".c-container").empty();
    $(".c-container").css("min-height", "auto");
    $(".c-container").append(
      '<p style="color: white;">This part of the website is not available on mobile devices. Please visit <a href="/events.html">/events.html</a></p>'
    );
  }
  ...
  function magnetic(el, e) {
    ...
    var deltaX = Math.floor(centerX - mX) * -0.4,
      deltaY = Math.floor(centerY - mY) * -0.4;
